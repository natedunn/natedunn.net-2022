    ...
    <li>
      <Link
        ...
        className={clsx(
          ...
          isActive
            ? 'text-teal-500 underline decoration-2 underline-offset-4 dark:text-teal-400'
...
function DesktopNavigation(props) {
  return (
    <nav {...props}>
      <ul className="flex font-medium text-zinc-800 dark:text-zinc-200">
  ...
  return (
    <>
      ...
      >
        <div
          ref={headerRef}
          className="bg-header top-0 z-10 py-6"
          // @ts-ignore
          ...
          >
            <div className="flex gap-4">
              <div className="flex flex-1">
                ...
                >
                  <svg
                    className="w-full max-w-[50px] text-zinc-900 dark:text-white"
                    viewBox="0 0 208 136"
                    fill="transparent"
